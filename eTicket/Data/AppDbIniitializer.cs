...
{
    public class AppDbIniitializer
    {
        public static void Seed(IApplicationBuilder applicationBuilder)
        {
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                if (!context.Producers.Any())
                {
                    context.Producers.AddRange(new List<Producer>()
                    {
                        ...
                        new Producer
                        {
                            ...
                            ProfilePicture = "https://dotnethow.net/images/producers/producer-5.jpeg"
                        },
                    });
                    context.SaveChanges();
                }
                ...
                if (!context.Movies.Any())
                {
                    ...
                    {
                        Name = "Oldboy",
                        Description = "This is the Oldboy movie description",
                        Price = 39.50,
                    ...
                    {
                        Name = "Toy Story 3",
                        Description = "This is the Toy Story 3 movie description",
                        Price = 30,
                        ImageURL = "http://dotnethow.net/images/movies/movie-9.jpeg",
                        StartDate = DateTime.Now,
                    ...
                    new Movie()
                    {
                        ...
                        Price = 45,
                        ImageURL = "http://dotnethow.net/images/movies/movie-10.jpeg",
                        StartDate = DateTime.Now,
                        EndDate = DateTime.Now.AddDays(10),
                        CinemaId = 4,
                        ProducerId = 1,
